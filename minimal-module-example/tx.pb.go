...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff062945f85c5ebc, []int{2}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff062945f85c5ebc, []int{3}
}
...
func init() {
	proto.RegisterType((*MsgIncrementCounter)(nil), "Torram.checkers.v1.MsgIncrementCounter")
	proto.RegisterType((*MsgIncrementCounterResponse)(nil), "Torram.checkers.v1.MsgIncrementCounterResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "Torram.checkers.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "Torram.checkers.v1.MsgUpdateParamsResponse")
}
...
var fileDescriptor_ff062945f85c5ebc = []byte{
	...
	0x49, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xda, 0x3d, 0x45, 0xcd, 0x42, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) IncrementCounter(ctx context.Context, in *MsgIncrementCounter, opts ...grpc.CallOption) (*MsgIncrementCounterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Torram.checkers.v1.Msg/IncrementCounter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Torram.checkers.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_IncrementCounter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Torram.checkers.v1.Msg/IncrementCounter",
	}
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Torram.checkers.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
